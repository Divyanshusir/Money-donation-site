...
<body background="image/children.jpg" style="    background-repeat: no-repeat;
background-size: 100%; ">
    ...
    <div class="qr">
    <h1 style="color:white;">Safe pay with QR </h1>
...
<div class="paymentform">
    <form action="payment.php?causeid=Child1" method="post" >
        ...
        <div class="Register">
            ...
            <a class="txt2" href="register.html" style=" color:yellow;">
                Register
